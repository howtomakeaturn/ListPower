...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_App__["a" /* default */], null), document.getElementById('create-list'));
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      $('#create-list-state').val(JSON.stringify(this.state.reviews));

      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', null, 'App v2');
    }
  }]);
